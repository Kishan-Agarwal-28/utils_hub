# Contributing to NPM Dashboard API
...
2. Clone your fork:
   ```bash
   git clone https://github.com/your-username/npm-dashboard-api.git
   cd npm-dashboard-api
   ```
...
Examples:
```
Add support for private npm registries

Implements authentication and fetching from private npm registries
